...
urlpatterns = patterns('',
                       ...
                       url(r'^coaching/(?P<group_slug>[a-z-]+)/list/$', CoachingSessionListView.as_view(), name='coaching-list'),
                       url(r'^coaching/(?P<group_slug>[a-z-]+)/(?P<employee_pk>[\d]+)/list/$', CoachingSessionListView.as_view(), name='coaching-employee-list'),
